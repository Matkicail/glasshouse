...
Split: {'kind': 'time', 'method': 'time_ordered', 'n_folds': 5, 'min_train_fraction': 0.3}. Rows: 17,379. Models: glm_poisson, lightgbm.
...
|---|---|---|---|
| deviance | 66.508 ± 19 | **43.015 ± 14** | 161.63 |
| d2 | 0.58618 ± 0.096 | **0.73281 ± 0.077** | 0 |
| gini | 0.39949 ± 0.021 | **0.44469 ± 0.016** | 0 |
| normalized_gini | 0.84323 ± 0.042 | **0.93867 ± 0.03** | 0 |
| balance | **1.4006 ± 0.17** | 1.405 ± 0.15 | 1 |
| rmse | 128.39 ± 33 | **103.63 ± 29** | 182.25 |
| mae | 85.364 ± 22 | **72.17 ± 23** | 146.7 |
| r2 | 0.49765 ± 0.11 | **0.6707 ± 0.095** | 0 |

Fit time (all folds): glm_poisson 1.3s, lightgbm 14.7s.
