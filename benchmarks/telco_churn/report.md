...
Split: {'kind': 'random', 'method': 'stratified', 'k': 5, 'seed': 0}. Rows: 7,043. Models: logistic, lasso_logistic, group_lasso_logistic.
...
|---|---|---|---|---|
| log_loss | 0.41859 ± 0.0097 | **0.41828 ± 0.01** | 0.42661 ± 0.012 | 0.5786 |
| brier | 0.13599 ± 0.0033 | **0.1359 ± 0.0035** | 0.13844 ± 0.004 | 0.19495 |
| roc_auc | 0.84327 ± 0.0088 | **0.84343 ± 0.0093** | 0.83731 ± 0.012 | 0.5 |
| average_precision | 0.65388 ± 0.016 | **0.65426 ± 0.018** | 0.64841 ± 0.014 | 0.26537 |
| ks | 0.53961 ± 0.02 | **0.54182 ± 0.019** | 0.52811 ± 0.031 | 0 |
| mcc | **0.46628 ± 0.024** | 0.4642 ± 0.022 | 0.44002 ± 0.02 | 0 |
| f1 | **0.59201 ± 0.02** | 0.58891 ± 0.02 | 0.55466 ± 0.02 | 0 |
| balance | 1.0008 ± 0.025 | **1.0006 ± 0.025** | 1.0007 ± 0.024 | 1 |

Fit time (all folds): logistic 1.4s, lasso_logistic 99.4s, group_lasso_logistic 109.7s.
